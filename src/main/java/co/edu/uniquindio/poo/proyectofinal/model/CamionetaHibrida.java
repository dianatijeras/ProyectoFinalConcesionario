...
public class CamionetaHibrida extends VehiculoHibrido implements ICalcularCostoTotal{
    ...
    /**
     * Constructor de la clase hija camionetaHibrida que hereda de la clase padre vehiculoHibrido
     * @param marca
     * @param placa
     * @param modelo
     * @param cambios
