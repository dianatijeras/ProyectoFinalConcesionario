...
public class PickUpCombustible extends VehiculoCombustible implements ICalcularCostoTotal{
    ...
    /**
     * Constructor de la clase hija pickUp combustible que hereda de la clase padre vehiculoCombustible
     * @param marca
     * @param placa
     * @param modelo
     * @param cambios
     ...
     * @param es4x4
     */
    public PickUpCombustible(String marca, String placa, String modelo, int cambios, int cilindraje, int velocidadMax, Estado estado, TipoTransmicion tipoTransmicion, TipoCombustible tipoCombustible, int capacidadTanque, int numPasajero, int numPuertas, int capacidadCajaCarga, boolean aireAcondicionado, boolean camaraReversa, int numBolsasAire, boolean abs, boolean es4x4) {
