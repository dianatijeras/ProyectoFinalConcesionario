...
public class BusCombustible extends VehiculoCombustible implements ICalcularCostoTotal{
    ...
    /**
     * Constructor de la clase hija busCombustible que hereda de la clase padre vehiculoCombustible
     * @param marca
     * @param placa
     * @param modelo
     * @param cambios
     ...
     */
    public BusCombustible(String marca, String placa, String modelo, int cambios, int cilindraje, int velocidadMax, Estado estado, TipoTransmicion tipoTransmicion, TipoCombustible tipoCombustible, int capacidadTanque, int numPasajeros, int numPuertas, int capacidadMaletero, boolean aireAcondicionado, boolean camaraReversa, int numBolsasAire, boolean abs, int numEjes, int numSalidasEmergencia) {
