...
public class SedanElectrico extends VehiculoElectrico implements ICalcularCostoTotal{
    ...
    /**
     * Constructor de la clase hija sedanElectrico que hereda de la clase vehiculoElectrico
     * @param marca
     * @param placa
     * @param modelo
     * @param cambios
     ...
     */
    public SedanElectrico(String marca, String placa, String modelo, int cambios, int cilindraje, int velocidadMax, Estado estado, TipoTransmicion tipoTransmicion, TipoCombustible tipoCombustible, int autonomiaCargaCompleta, int tiempoCargaPromedio, int numPasajero, int numPuertas, int capacidadMaletero, boolean aireAcondicionado, boolean camaraReversa, boolean velocidadCrucero, int numBolsasAire, boolean abs, boolean sensoresColision, boolean sensorTraficoCruzado, boolean asistentePermanenciaCarril) {
