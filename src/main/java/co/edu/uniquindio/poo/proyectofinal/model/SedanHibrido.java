...
public class SedanHibrido extends VehiculoHibrido implements ICalcularCostoTotal{
    ...
    /**
     * Constructor de la clase hija sedanHibrido que hereda de la clase padre vehiculoHibrido
     * @param marca
     * @param placa
     * @param modelo
     * @param cambios
