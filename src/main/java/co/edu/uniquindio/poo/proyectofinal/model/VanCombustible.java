...
public class VanCombustible extends VehiculoCombustible implements ICalcularCostoTotal{
    ...
    /**
     * Constructor de la clase hija vanCombustible que hereda de la clase padre vehiculoCombustible
     * @param marca
     * @param placa
     * @param modelo
     * @param cambios
